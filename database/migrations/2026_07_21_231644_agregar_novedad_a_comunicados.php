...
return new class extends Migration {
    public function up(): void
    {
        ...
        // MySQL: MODIFY directamente sobre el ENUM existente
        DB::statement("ALTER TABLE comunicados MODIFY com_tipo
            ENUM('normal','modal','destacado','novedad')
